...
#' HINT: Missing values in this column are expressed by 'N/A'
#' HINT: You will need to remove the '%' from the vector using gsub
...
#' Additionally, it is also important to validate the Gauss-Markov assumptions;
#' fortunately R has built-in functionality to do this
plot(lm1)
