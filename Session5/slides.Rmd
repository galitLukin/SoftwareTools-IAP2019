...
>- **Asking impactful questions** of a data set;
>- **Choosing appropriate methods** by which to answer those questions; and  
>- **implementing** those methods in practical fashion. 
...
## My Favorite Picture {data-transition="none"}
...
>- Display our results in an attractive format suitable for presentations to decision-makers. 
...
1. Open `my_case_study.R` in RStudio. You may use `case_study_complete.R` for troubleshooting if needed. 
2. Open `my_dashboard.rmd` in RStudio. 
3. Session $\rightarrow$ Set Working Directory $\rightarrow$ To Source File Location. 
